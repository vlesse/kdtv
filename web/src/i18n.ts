...
const zh: Dict = {
  ...
  'vod.pause': '暂停',
  'vod.seekHint': '◀ ▶ 快退 / 快进 15 秒 · 数字键 0–9 跳到片长的 0%–90%',
  'vod.next': '下一集',
  'vod.episodes': '剧集（{n}）',
  'vod.series': '剧集',
  'vod.film': '电影',
...
const en: Dict = {
  ...
  'vod.pause': 'Pause',
  'vod.seekHint': '◀ ▶ skip 15s · keys 0–9 jump to 0%–90%',
...
const km: Dict = {
  ...
  'vod.pause': 'ផ្អាក',
  'vod.seekHint': '◀ ▶ រំលង ១៥ វិ. · លេខ ០–៩ លោតទៅ ០%–៩០%',
...
const id: Dict = {
  ...
  'vod.pause': 'Jeda',
  'vod.seekHint': '◀ ▶ lompat 15 dtk · tombol 0–9 ke 0%–90%',
